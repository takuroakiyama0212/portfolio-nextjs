...
const AboutSection = () => {
  ...
  const techStack = [
    ...
    { name: 'TanStack Query', color: 'bg-pink-400' },
    { name: 'Google Maps API', color: 'bg-red-500' },
    { name: 'Python', color: 'bg-blue-600' },
    { name: 'Cryptography', color: 'bg-purple-600' },
    { name: 'Flask', color: 'bg-gray-900' },
    { name: 'JavaScript', color: 'bg-yellow-500' },
    { name: 'Chrome Extension API', color: 'bg-blue-500' },
